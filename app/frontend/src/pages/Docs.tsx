...
export default function Docs() {
    ...
    const sections: Record<Section, string> = {
        ...
        cli: "The MLnexus CLI Reference",
        runtime: "The MLnexus Runtime Reference",
    };
    ...
    return (
        <div className="mx-auto flex w-full max-w-7xl flex-col md:flex-row py-8 px-4 sm:px-6 lg:px-8">
            ...
            <nav className="w-full md:w-64 flex-shrink-0 pr-8 mb-8 md:mb-0">
                ...
                <div className="mt-8 border-t border-slate-800 pt-8">
                    ...
                    <ul className="space-y-2 text-sm text-slate-400">
                        <li>
                            <Link to="/explore" className="hover:text-pink-400 transition-colors">
                                Explore Published Models
                            </Link>
                        </li>
                        <li>
                            <Link to={isAuthenticated ? "/manage" : "/login"} className="hover:text-pink-400 transition-colors">
                                Publish a Model
                            </Link>
                        </li>
                    </ul>
            ...
            {}
            <main className="flex-1 min-w-0 prose prose-invert prose-pink max-w-none">
...
function IntroSection() {
    return (
        <div className="space-y-6 text-slate-300">
            <h1 className="text-4xl font-extrabold text-white mb-2">Welcome to MLnexus</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 mb-8">
                <div className="bg-red-950/20 border border-red-900/40 rounded-xl p-5">
                    <h3 className="text-red-400 font-bold mb-2">The Old Era (Without MLnexus)</h3>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">The MLnexus Ecosystem</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-4 mt-4">
                <li>
                    <strong className="text-pink-400 text-lg">The Global Extradition Registry:</strong> A colossal, centralized global network containing public machine learning packages. It ensures lightning-fast downloads around the planet and guarantees code immutability so consumer applications never randomly break.
                </li>
                <li>
                    <strong className="text-emerald-400 text-lg">The Local CLI Environment:</strong> A sophisticated CLI program (<code>@mlnexus/cli</code>) executed exclusively on your local workstation and your remote deployment platforms. It oversees tracking precisely which models your application depends on, downloads them seamlessly into your system architecture, handles caching to stop duplicate bandwidth execution, and securely binds the logic correctly.
                </li>
                <li>
                    <strong className="text-pink-400 text-lg">The Standard Runtime:</strong> A heavily optimized native server-side utility (<code>@mlnexus/runtime</code>). This enables your Javascript code to safely orchestrate mathematical executions natively at the speed of compiled code without you ever learning the mathematics behind it.
                </li>
            </ul>

            <h2 className="text-2xl font-bold text-white mt-8 mb-4">The Universal Workflow</h2>
            <p className="mb-4">Here is the exact step-by-step process of integrating MLnexus into any major web system:</p>
            ...
            <ol className="list-decimal pl-6 space-y-4 text-slate-300">
                ...
                <li>
                    ...
                    <pre className="bg-slate-900 border border-slate-800 p-4 rounded-xl mt-2 text-sm"><code>{`npm install @mlnexus/runtime
npm install -g @mlnexus/cli`}</code></pre>
                </li>
                <li>
                    <strong>Acquisition:</strong> Using the globally integrated CLI, you request a package. MLnexus securely grabs the necessary gigabytes over our network.
                    <pre className="bg-slate-900 border border-slate-800 p-4 rounded-xl mt-2 text-sm"><code>{`mlnexus install house-price-predictor@latest`}</code></pre>
                </li>
                <li>
            ...
            <div className="bg-pink-950/30 border border-pink-900/50 rounded-xl p-6 mt-10">
                <h3 className="text-xl font-bold text-pink-400 mb-2">⚠️ Backend-Only Architecture</h3>
                <p className="text-slate-300">
                    MLnexus is architected exclusively for <strong>Node.js Backend Environments</strong>. Because the runtime requires 
...
function PublishSection() {
    return (
        <div className="space-y-6 text-slate-300">
            ...
            <p>
                The MLnexus Unified Dashboard is the exclusive method for AI maintainers and Data Scientists 
            ...
            <p>Before launching a model to MLnexus, you must comprehensively guarantee two aspects of your model.</p>
            <ul className="list-disc pl-6 space-y-4 mt-4">
                <li>
            ...
            <p>
                MLnexus strictly enforces Semantic Versioning. A single package name (e.g. <code>sentiment-detector</code>) lasts forever, but it can evolve through continuous updates globally. 
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 mt-4">
                ...
                <ul className="space-y-4">
                    <li className="border-b border-slate-800 pb-4">
                        ...
                        Increase this when you structurally modify what the MLnexus Web Developer receives or inputs. For example: if your model used to require an input variable called <code>"text"</code> but you decided to fundamentally rename it to <code>"phrase"</code>, the old code will crash. You MUST issue a Major version bump.
                    </li>
                    <li className="border-b border-slate-800 pb-4">
            ...
            <ol className="list-decimal pl-6 space-y-3 mt-4">
                ...
                <li>Navigate precisely to the <Link to={getToken() ? "/manage" : "/login"} className="text-pink-400 hover:text-pink-300 font-semibold underline">Publish a Model</Link> portal.</li>
                <li><strong>Naming:</strong> Input a memorable, concise identifier (no spaces or special punctuation). This is exactly what millions of developers will type into terminal: <code>mlnexus install &lt;name&gt;</code>.</li>
...
function WrappersSection() {
    return (
        <div className="space-y-6 text-slate-300">
            ...
            <p>
                When a developer runs <code>mlnexus install</code>, this wrapper is downloaded and injected directly into their project as the executable interface for your model, always named <code>wrapper.config.js</code>.
            </p>
...
{`export default {
    ...
    // ... at least one of predict or stream must follow
            ...
            <p className="mb-4 text-sm text-slate-400">
                ...
                interfaces define the exact shape expected by the MLnexus Runtime.
            </p>
...
interface TensorConfig {
    ...
    type: "float32" | "int32" | "int64" | "bool" | "string";
                ...
                <table className="w-full text-sm border-collapse">
                    ...
                    <tbody className="text-slate-300">
                        <tr className="border-b border-slate-800">
                            <td className="py-2 pr-6"><code className="text-pink-400">"float32"</code></td>
                        ...
                        <tr className="border-b border-slate-800">
                            <td className="py-2 pr-6"><code className="text-pink-400">"int32"</code></td>
                            <td className="py-2 pr-6"><code>number[]</code></td>
                            <td className="py-2">Token IDs for NLP models. Class indices. Integer sequences.</td>
                        </tr>
                        <tr className="border-b border-slate-800">
                            <td className="py-2 pr-6"><code className="text-pink-400">"int64"</code></td>
                        ...
                        <tr className="border-b border-slate-800">
                            <td className="py-2 pr-6"><code className="text-pink-400">"bool"</code></td>
                            <td className="py-2 pr-6"><code>boolean[]</code></td>
                            <td className="py-2">Attention masks and binary flags.</td>
                        </tr>
                        <tr>
                            <td className="py-2 pr-6"><code className="text-pink-400">"string"</code></td>
            ...
            <p className="mb-4">
                Inside <code>predict</code>, you receive two arguments automatically provided by the MLnexus Runtime:
            </p>
...
{`export default {
    ...
    async *stream(sessions, input) {
        ...
        for (let i = 0; i < 256; i++) {
            ...
            <p>
                If you publish a model without uploading a <code>wrapper.config.js</code>, the MLnexus CLI detects this when a 
...
function CliSection() {
    return (
        <div className="space-y-6 text-slate-300">
            ...
            <p>
                The <code>@mlnexus/cli</code> system globally manages everything. It actively ensures web developers don't have to manually download, compress, verify, or inject models ever again.
                Once installed globally via <code>npm install -g @mlnexus/cli</code>, the following operations are natively available universally.
            </p>

            <div className="mt-10">
                <code className="text-xl font-bold text-pink-400 block mb-3">mlnexus install &lt;package-name&gt;[@version]</code>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm text-slate-300">
                    ...
                    <li>It caches the massive models structurally into the isolated <code>~/.mlnexus/cache</code> directory perfectly, massively saving SSD space if you utilize the same model across ten different company apps.</li>
  ...
  "scripts": {
    "postinstall": "mlnexus restore"
                ...
                <div className="bg-pink-950/30 p-3 mt-4 text-xs rounded border border-pink-900/50">
                    <strong>Troubleshooting:</strong> If installation fails halfway on a 5GB model, your internet connection significantly faltered. Simply re-run the command; the MLnexus systems are completely idempotent.
                </div>
            </div>

            <div className="mt-12">
                <code className="text-xl font-bold text-emerald-400 block mb-3">mlnexus restore</code>
                <p className="mb-4 text-slate-200">
                ...
                <p className="text-sm text-slate-300 mb-4">
                    ...
                    files are not in git (they are too large and live in <code>~/.mlnexus/cache</code> on your machine). 
                    <code>mlnexus restore</code> reads the <code>"mlnexus"</code> section of your <code>package.json</code>, 
                ...
                <div className="bg-emerald-950/30 p-4 mt-4 text-sm rounded border border-emerald-900/50">
                    ...
                    <p className="text-slate-300">
                        Every time you run <code>mlnexus install &lt;package&gt;</code>, the CLI automatically injects the following 
    ...
    "postinstall": "mlnexus restore"
                    ...
                    <p className="text-slate-400 mt-3 text-xs">
                        If a <code>postinstall</code> script already exists in your project, MLnexus appends itself safely 
            ...
            <div className="mt-12">
                <code className="text-xl font-bold text-amber-400 block mb-3">mlnexus uninstall &lt;package-name&gt;</code>
                <p className="mb-4 text-slate-200">
            ...
            <div className="mt-12">
                <code className="text-xl font-bold text-white block mb-3">mlnexus list</code>
                <p className="mb-4 text-slate-200">
            ...
            <div className="mt-12">
                <code className="text-xl font-bold text-sky-400 block mb-3">mlnexus cache list</code>
                <p className="mb-4 text-slate-200">
                    A critical utility for isolated system storage awareness.
                </p>
                <p className="text-sm text-slate-300">
                    Models require extraordinary disk real-estate globally. This command intricately loops through your exact operating system <code>~/.mlnexus/cache/</code> central cache repository seamlessly, detailing exactly what models exist persistently locally and comprehensively calculating precise byte usage limits for you natively.
                </p>
            </div>

            <div className="mt-12">
                <code className="text-xl font-bold text-red-500 block mb-3">mlnexus cache clean [package-name]</code>
                <p className="mb-4 text-slate-200">
                ...
                <p className="text-sm text-slate-300">
                    ...
                    Supplying a specific identifier (like <code>mlnexus cache clean sentiment-model</code>) strictly isolates the destruction natively to that specific entity structurally.
                </p>
            ...
            <p className="mb-6 text-slate-300">
                The MLnexus CLI reads one optional environment variable. Most users will never need to set it — the CLI ships 
                pre-configured to point at the official MLnexus registry automatically.
            </p>

            <div className="mt-4">
                <code className="text-lg font-bold text-yellow-400 block mb-2">MLnexus_REGISTRY</code>
                <p className="text-sm text-slate-300 mb-3">
                    Overrides the registry URL that the CLI connects to. By default, all CLI commands target 
                    the official MLnexus global registry. You only need to set this variable if you are:
                </p>
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 mt-4">
                    ...
                    <pre className="text-sm text-yellow-300">{`export MLnexus_REGISTRY=https://your-private-registry.com`}</pre>
                </div>
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 mt-3">
                    ...
                    <pre className="text-sm text-yellow-300">{`$env:MLnexus_REGISTRY = "https://your-private-registry.com"`}</pre>
                </div>
...
Variable value: https://your-private-registry.com`}</pre>
                ...
                <p className="text-sm text-slate-500 mt-4">
                    Once set, every subsequent CLI command — <code>mlnexus install</code>, <code>mlnexus restore</code>, 
                    <code>mlnexus list</code> — will point at your custom registry. No other configuration is required.
                </p>
            </div>
        </div>
    );
...
function RuntimeSection() {
    return (
        <div className="space-y-6 text-slate-300">
            ...
            <p>
                The global CLI fetches the massive bytes locally, however, the <strong>Standard Runtime Engine</strong> (<code>@mlnexus/runtime</code>) is strictly the library that mathematical executes and orchestrates them perfectly inside your structural backend applications dynamically.
            ...
            <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 mt-10">
                ...
                <div className="space-y-4">
                    <div className="bg-black/40 p-4 rounded-lg border border-slate-800">
                        <strong className="text-pink-400 block mb-1">Native Dependencies</strong>
