        ...
        <div className="max-w-5xl w-full mx-auto px-6 py-10">
            <div className="mb-8">
                ...
                <p className="text-white/60">
                    Manage critical actions for your published MLnexus models.
                </p>
            </div>
            ...
            <div className="grid items-start gap-8 lg:grid-cols-2">
                <form
                    ...
                    className="rounded-2xl border border-white/10 bg-black/60 p-6 backdrop-blur-sm shadow-[0_0_20px_rgba(0,0,0,0.5)]"
                >
                    ...
                    <input
                        ...
                        className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-white/90 placeholder:text-white/30 focus:border-red-400 focus:outline-none focus:ring-1 focus:ring-red-400"
                        required
                    />
                    <label className="mt-4 flex items-center gap-3 text-sm text-white/70">
                        <input
                            ...
                            className="h-4 w-4 rounded border-white/20 bg-black/80 text-red-500 focus:ring-red-500"
                        />
                    ...
                    >
                        {isDeleting ? "Yanking..." : "Yank Package"}
                    </button>
                </form>
                ...
                >
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g. vision-encoder"
                                className="w-full rounded-xl border border-white/10 bg-black/40 px-4 py-3 text-white/90 placeholder:text-white/30 focus:border-pink-500 focus:outline-none focus:ring-1 focus:ring-pink-500"
                                required
                            />
                        </div>
                        <div>
                    ...
                    <button
                        ...
                        className="mt-6 w-full rounded-xl border border-pink-500/40 bg-pink-500/10 px-4 py-3 text-sm font-semibold text-pink-200 hover:bg-pink-500/20 transition-colors disabled:opacity-60"
                    >
