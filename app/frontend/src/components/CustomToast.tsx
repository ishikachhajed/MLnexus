...
export default function CustomToast({ toast, onOpenChange }: CustomToastProps) {
    return (
        <Toast.Root
            ...
            className="group w-[320px] rounded-2xl border border-white/20 bg-black/95 p-4 text-left text-slate-100 shadow-[0_12px_30px_rgba(236,72,153,0.15)] backdrop-blur data-[state=open]:animate-[toast-in_200ms_ease-out] data-[state=closed]:animate-[toast-out_200ms_ease-in]"
        >
